...
(ColorMarker = class ColorMarker {
  ...
  copyContentAsHex() { return lumine.clipboard.write(this.convertContent('hex')); }

  copyContentAsRGB() { return lumine.clipboard.write(this.convertContent('rgb')); }

  copyContentAsRGBA() { return lumine.clipboard.write(this.convertContent('rgba')); }

  copyContentAsHSL() { return lumine.clipboard.write(this.convertContent('hsl')); }

  copyContentAsHSLA() { return lumine.clipboard.write(this.convertContent('hsla')); }
