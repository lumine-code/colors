...
(Color = (function() {
  Color = class Color {
    static initClass() {
      ...
      this.colorComponents.forEach(function(...args) {
        ...
        return Object.defineProperty(Color.prototype, component, {
          ...
          set(component) { return this[index] = component; }
        });});
      ...
      Object.defineProperty(Color.prototype, 'rgba', {
        enumerable: true,
        get() { return [this.red, this.green, this.blue, this.alpha]; },
        set(...args) {
      ...
      Object.defineProperty(Color.prototype, 'argb', {
        enumerable: true,
        get() { return [this.alpha, this.red, this.green, this.blue]; },
        set(...args) {
      ...
      Object.defineProperty(Color.prototype, 'hsv', {
        ...
        set(hsv) {
          let ref;
          loadConverters();
          return [this.red, this.green, this.blue] = Array.from(ref = hsvToRGB.apply(this.constructor, hsv)), ref;
        }
      });
  
      Object.defineProperty(Color.prototype, 'hsva', {
        enumerable: true,
        get() { return this.hsv.concat(this.alpha); },
        set(hsva) {
          let h, ref, s, v;
          loadConverters();
          [h,s,v,this.alpha] = Array.from(hsva);
          return [this.red, this.green, this.blue] = Array.from(ref = hsvToRGB.apply(this.constructor, [h,s,v])), ref;
        }
      });
      ...
      Object.defineProperty(Color.prototype, 'hcg', {
        ...
        set(hcg) {
          let ref;
          loadConverters();
          return [this.red, this.green, this.blue] = Array.from(ref = hcgToRGB.apply(this.constructor, hcg)), ref;
        }
      });
  
      Object.defineProperty(Color.prototype, 'hcga', {
        enumerable: true,
        get() { return this.hcg.concat(this.alpha); },
        set(hcga) {
          let c, gr, h, ref;
          loadConverters();
          [h,c,gr,this.alpha] = Array.from(hcga);
          return [this.red, this.green, this.blue] = Array.from(ref = hcgToRGB.apply(this.constructor, [h,c,gr])), ref;
        }
      });
      ...
      Object.defineProperty(Color.prototype, 'hsl', {
        ...
        set(hsl) {
          let ref;
          loadConverters();
          return [this.red, this.green, this.blue] = Array.from(ref = hslToRGB.apply(this.constructor, hsl)), ref;
        }
      });
  
      Object.defineProperty(Color.prototype, 'hsla', {
        enumerable: true,
        get() { return this.hsl.concat(this.alpha); },
        set(hsl) {
          let h, l, ref, s;
          loadConverters();
          [h,s,l,this.alpha] = Array.from(hsl);
          return [this.red, this.green, this.blue] = Array.from(ref = hslToRGB.apply(this.constructor, [h,s,l])), ref;
        }
      });
      ...
      Object.defineProperty(Color.prototype, 'hwb', {
        ...
        set(hwb) {
          let ref;
          loadConverters();
          return [this.red, this.green, this.blue] = Array.from(ref = hwbToRGB.apply(this.constructor, hwb)), ref;
        }
      });
  
      Object.defineProperty(Color.prototype, 'hwba', {
        enumerable: true,
        get() { return this.hwb.concat(this.alpha); },
        set(hwb) {
          let b, h, ref, w;
          loadConverters();
          [h,w,b,this.alpha] = Array.from(hwb);
          return [this.red, this.green, this.blue] = Array.from(ref = hwbToRGB.apply(this.constructor, [h,w,b])), ref;
        }
      });
      ...
      Object.defineProperty(Color.prototype, 'hex', {
        ...
        set(hex) {
          let ref;
          loadConverters();
          return [this.red, this.green, this.blue] = Array.from(ref = hexToRGB(hex)), ref;
        }
      });
      ...
      Object.defineProperty(Color.prototype, 'hexARGB', {
        ...
        set(hex) {
          let ref;
          loadConverters();
          return [this.red, this.green, this.blue, this.alpha] = Array.from(ref = hexARGBToRGB(hex)), ref;
        }
      });
      ...
      Object.defineProperty(Color.prototype, 'hexRGBA', {
        ...
        set(hex) {
          let ref;
          loadConverters();
          return [this.red, this.green, this.blue, this.alpha] = Array.from(ref = hexRGBAToRGB(hex)), ref;
        }
      });
      ...
      Object.defineProperty(Color.prototype, 'cmyk', {
        ...
        set(cmyk) {
          ...
          return [this.red, this.green, this.blue] = Array.from(ref = cmykToRGB(c,m,y,k)), ref;
        }
      });
      ...
      Object.defineProperty(Color.prototype, 'suggestionValues', {
        ...
        get() {
          ...
          return [
            this.alpha === 1 ? `#${this.hex}` : `#${this.hexRGBA}`,
            this.toCSS()
          ];
        }
      });
    ...
    static isValid(color) {
      return (color != null) && !color.invalid &&
      (color.red != null) && (color.green != null) &&
      (color.blue != null) && (color.alpha != null) &&
      !isNaN(color.red) && !isNaN(color.green) &&
      !isNaN(color.blue) && !isNaN(color.alpha);
    }
    ...
    constructor(r=0,g=0,b=0,a=1) {
      if (typeof r === 'object') {
        let v;
        if (Array.isArray(r)) {
          for (let i = 0; i < r.length; i++) { v = r[i]; this[i] = v; }
        } else {
          for (var k in r) { v = r[k]; this[k] = v; }
        }
      } else if (typeof r === 'string') {
        if (SVGColors == null) { SVGColors = require('./svg-colors'); }
    ...
    isLiteral() { return (this.variables == null) || (this.variables.length === 0); }

    isValid() {
      return this.constructor.isValid(this);
    }

    clone() { return new Color(this.red, this.green, this.blue, this.alpha); }
