...
const rgbToHSV = function(r, g, b) {
  ...
  if (delta === 0) {
    ...
    if (r === v) {      h = deltaB - deltaG;
    } else if (g === v) { h = ((1 / 3) + deltaR) - deltaB;
    } else if (b === v) { h = ((2 / 3) + deltaG) - deltaR; }
...
const hsvToRGB = function(h, s, v) {
  ...
  if (s === 0) {
    ...
    switch (dominant) {
      case 0: [r, g, b] = Array.from([v, comp3, comp1]); break;
      case 1: [r, g, b] = Array.from([comp2, v, comp1]); break;
      case 2: [r, g, b] = Array.from([comp1, v, comp3]); break;
      case 3: [r, g, b] = Array.from([comp1, comp2, v]); break;
      case 4: [r, g, b] = Array.from([comp3, comp1, v]); break;
      default:        [r, g, b] = Array.from([v, comp1, comp2]);
    }
...
const rgbToHCG = function(r, g, b) {
  ...
  if (c > 0) {
    ...
    switch (max) {
      case r:
        h = ((g - b) / c) + ((left = g < b) != null ? left : {6 : 0});
        break;
      case g:
        h = ((b - r) / c) + 2;
        break;
