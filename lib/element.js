...
const TAGS = [
  "a", "br", "button", "code", "div", "footer", "h1", "h2", "h3", "h4", "h5", "h6",
  "header", "i", "img", "input", "label", "li", "option", "p", "pre", "section",
  "select", "small", "span", "strong", "table", "tbody", "td", "th", "thead", "tr", "ul",
];
...
class DomBuilder {
  ...
  tag(name, ...args) {
    ...
    for (const arg of args) {
      ...
      else if (typeof arg === "string" || typeof arg === "number") element.textContent = String(arg);
