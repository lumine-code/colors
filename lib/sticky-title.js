  ...
  StickyTitle = class StickyTitle {
    ...
    constructor(stickies, scrollContainer) {
      ...
      this.subscriptions.add(
        this.subscribeTo(this.scrollContainer, {
          scroll: (e) => {
    ...
    scroll(e) {
      const delta = this.lastScrollTop ? this.lastScrollTop - this.scrollContainer.scrollTop : 0;
