...
class ColorProjectElement extends ColorsElement {
...
`
        ...
        return this.div({class: 'fields'}, () => {
          ...
          return booleanField('includeThemes', 'Include Lumine Themes Stylesheets', `\
...
module.exports =
(ColorProjectElement =
defineElement('colors-color-project', ColorProjectElement));
