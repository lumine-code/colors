...
// blue(#000,255)
registry.createExpression(
  "colors:stylus_component_functions",
  strip(`\
(red|green|blue)${ps} \
(${notQuote}) \
${comma} \
...
// lightness(#855, 60deg)
registry.createExpression(
  "colors:stylus_sl_component_functions",
  strip(`\
...
registry.createExpression(
  "colors:latex_predefined_dvipnames",
  strip(`\
