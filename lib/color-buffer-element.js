...
.${className} {
  ...
  background-image:
    ...
    url(atom://colors/resources/transparent-background.png);
...
`;
  ...
  getGutterDecorationItem(marker) {
    ...
    div.innerHTML = `\
<span style='background-image: linear-gradient(to bottom, ${marker.color.toCSS()} 0%, ${marker.color.toCSS()} 100%), url(atom://colors/resources/transparent-background.png);' data-marker-id='${marker.id}'></span>\
`;
    return div;
  }
...
module.exports =
(ColorBufferElement =
registerOrUpdateElement('colors-markers', ColorBufferElement.prototype));
