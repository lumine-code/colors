...
describe('ColorBufferElement', function() {
  ...
  return describe('when an editor is opened', function() {
    ...
    describe('when the color buffer is initialized', function() {
      ...
      it('creates markers views for every visible buffer marker', () => expect(getEditorDecorations('native-background').length).toEqual(3));

      describe('when the project variables are initialized', () => it('creates markers for the new valid colors', function() {
      ...
      describe('when some markers are destroyed', function() {
        ...
        return it('releases the unused markers', () => expect(getEditorDecorations('native-background').length).toEqual(2));
      });
      ...
      return describe('when the marker type is set to gutter', function() {
        ...
        it('sets the size of the gutter based on the number of markers in the same row', () => expect(gutter.style.minWidth).toEqual('14px'));
        ...
        describe('when the variables become available', function() {
          ...
          return describe('when many markers are added on the same line', function() {
            ...
            it('sets the size of the gutter based on the number of markers in the same row', () => expect(gutter.style.minWidth).toEqual('42px'));
            ...
            return describe('clicking on a gutter decoration', function() {
              ...
              it('selects the text in the editor', () => expect(editor.getSelectedScreenRange()).toEqual([[0,13],[0,17]]));

              return it('opens the color picker', () => expect(project.colorPickerAPI.open).toHaveBeenCalled());
            });
          });
        });
