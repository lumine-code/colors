...
describe('ColorParser', function() {
  ...
  beforeEach(function() {
    const svgColorExpression = registry.getExpression('pigments:named_colors');
      ...
      asColor(r,g,b,a=1) {
        ...
        return describe(this.description, function() {
          ...
          return it(`parses '${expression}' as a color`, function() {
            return expect(parser.parse(expression, this.scope != null ? this.scope : 'less')).toBeColor(r,g,b,a);
          });
        });
      },
      ...
      asUndefined() {
        ...
        return describe(this.description, function() {
          ...
          return it(`does not parse '${expression}' and return undefined`, function() {
            return expect(parser.parse(expression, this.scope != null ? this.scope : 'less')).toBeUndefined();
          });
        });
      },
      ...
      asInvalid() {
        ...
        return describe(this.description, function() {
          ...
          return it(`parses '${expression}' as an invalid color`, function() {
            return expect(parser.parse(expression, this.scope != null ? this.scope : 'less')).not.toBeValid();
          });
        });
      },
  ...
  describe('in context other than css and pre-processors', function() {
    beforeEach(function() { return this.scope = 'xaml'; });
  ...
  describe('css', function() {
    beforeEach(function() { return this.scope = 'css'; });
  ...
  describe('less', function() {
    beforeEach(function() { return this.scope = 'less'; });
  ...
  describe('stylus and less', function() {
    beforeEach(function() { return this.scope = 'styl'; });
  ...
  describe('scss and sass', function() {
    describe('with compass implementation', function() {
      beforeEach(function() { return this.scope = 'sass:compass'; });
    ...
    return describe('with bourbon implementation', function() {
      beforeEach(function() { return this.scope = 'sass:bourbon'; });
  ...
  describe('lua color', function() {
    beforeEach(function() { return this.scope = 'lua'; });
  ...
  describe('elm-lang support', function() {
    beforeEach(function() { return this.scope = 'elm'; });
  ...
  describe('latex support', function() {
    beforeEach(function() { return this.scope = 'tex'; });
