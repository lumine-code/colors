...
["mousedown", "mousemove", "mouseup", "click"].forEach(
  (key) =>
    (module.exports[key] = function (target, x, y, cx, cy, btn) {
      if (x == null || y == null) {
        ({ x, y } = objectCenterCoordinates(target));
      }
      ...
      return target.dispatchEvent(
        mouseEvent(key, { target, pageX: x, pageY: y, clientX: cx, clientY: cy, button: btn }),
      );
    }),
);
