...
describe('Color', function() {
  ...
  describe('created with separated components', () => it('creates the color with the provided components', () => expect(new Color(255, 127, 64, 0.5)).toBeColor(255, 127, 64, 0.5)));

  describe('created with a hexa rgb string', () => it('creates the color with the provided components', () => expect(new Color('#ff6933')).toBeColor(255, 105, 51, 1)));

  describe('created with a hexa argb string', () => it('creates the color with the provided components', () => expect(new Color('#66ff6933')).toBeColor(255, 105, 51, 0.4)));

  describe('created with the name of a svg color', () => it('creates the color using its name', () => expect(new Color('orange')).toBeColor('#ffa500')));

  describe('::isValid', function() {
    it('returns true when all the color components are valid', () => expect(new Color).toBeValid());
  ...
  describe('::isLiteral', function() {
    it('returns true when the color does not rely on variables', () => expect(new Color('orange').isLiteral()).toBeTruthy());
  ...
  describe('::rgb', function() {
    it('returns an array with the color components', () => expect(color.rgb).toBeComponentArrayCloseTo([
      color.red,
      color.green,
      color.blue
    ]));
  ...
  describe('::rgba', function() {
    it('returns an array with the color and alpha components', () => expect(color.rgba).toBeComponentArrayCloseTo([
      color.red,
      color.green,
      color.blue,
      color.alpha
  ...
  describe('::argb', function() {
    it('returns an array with the alpha and color components', () => expect(color.argb).toBeComponentArrayCloseTo([
      color.alpha,
      color.red,
      color.green,
      color.blue
  ...
  describe('::hsv', function() {
    it('returns an array with the hue, saturation and value components', () => expect(color.hsv).toBeComponentArrayCloseTo([16, 80, 100]));
  ...
  describe('::hsva', function() {
    it('returns an array with the hue, saturation, value and alpha components', () => expect(color.hsva).toBeComponentArrayCloseTo([16, 80, 100, 0.4]));
  ...
  describe('::hcg', function() {
    it('returns an array with the hue, chroma and gray components', () => expect(color.hcg).toBeComponentArrayCloseTo([16, 80, 100]));
  ...
  describe('::hcga', function() {
    it('returns an array with the hue, chroma, gray and alpha components', () => expect(color.hcga).toBeComponentArrayCloseTo([16, 80, 100, 0.4]));
  ...
  describe('::hsl', function() {
    it('returns an array with the hue, saturation and luminosity components', () => expect(color.hsl).toBeComponentArrayCloseTo([16, 100, 60]));
  ...
  describe('::hsla', function() {
    it('returns an array with the hue, saturation, luminosity and alpha components', () => expect(color.hsla).toBeComponentArrayCloseTo([16, 100, 60, 0.4]));
  ...
  describe('::hwb', function() {
    it('returns an array with the hue, whiteness and blackness components', () => expect(color.hwb).toBeComponentArrayCloseTo([16, 20, 0]));
  ...
  describe('::hwba', function() {
    it('returns an array with the hue, whiteness, blackness and alpha components', () => expect(color.hwba).toBeComponentArrayCloseTo([16, 20, 0, 0.4]));
  ...
  describe('::hexARGB', function() {
    it('returns the color component as a hexadecimal string', () => expect(color.hexARGB).toEqual('66ff6933'));
  ...
  describe('::clone', () => it('returns a copy of the current color', function() {
    expect(color.clone()).toBeColor(color);
    return expect(color.clone()).not.toBe(color);
  }));

  describe('::toCSS', function() {
    describe('when the color alpha channel is not 1', () => it('returns the color as a rgba() color', () => expect(color.toCSS()).toEqual('rgba(255,105,51,0.4)')));

    describe('when the color alpha channel is 1', () => it('returns the color as a rgb() color', function() {
      color.alpha = 1;
      return expect(color.toCSS()).toEqual('rgb(255,105,51)');
    }));

    return describe('when the color have a CSS name', () => it('only returns the color name', function() {
      color = new Color('orange');
      return expect(color.toCSS()).toEqual('rgb(255,165,0)');
    }));
  });

  describe('::interpolate', () => it('blends the passed-in color linearly based on the passed-in ratio', function() {
  ...
  describe('::blend', () => it('blends the passed-in color based on the passed-in blend function', function() {
    const colorA = new Color('#ff0000');
    const colorB = new Color('#0000ff');
  ...
  describe('::transparentize', () => it('returns a new color whose alpha is the passed-in value', function() {
  ...
  return describe('::luma', () => it('returns the luma value of the color', () => expect(color.luma).toBeCloseTo(0.31, 1)));
});
