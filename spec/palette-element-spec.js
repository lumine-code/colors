...
describe('PaletteElement', function() {
  ...
  describe('as a view provider', function() {
    ...
    it('does not render alernate form of a variable', () => expect(paletteElement.querySelectorAll('li').length).toEqual(5));
  ...
  describe('when pigments:show-palette commands is triggered', function() {
    ...
    it('creates as many list item as there is colors in the project', function() {
      ...
      return expect(paletteElement.querySelectorAll('li').length).toEqual(palette.variables.filter(v => !v.isAlternate).length);
    });
  ...
  describe('when the palette settings differs from defaults', function() {
    ...
    return describe('when pigments:show-palette commands is triggered', function() {
      ...
      describe('the sorting selector', () => it('selects the current value', function() {
      ...
      describe('the grouping selector', () => it('selects the current value', function() {
