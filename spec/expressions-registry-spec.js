...
describe('ExpressionsRegistry', function() {
  ...
  describe('::createExpression', () => describe('called with enough data', () => it('creates a new expression of this registry expressions type', function() {
  ...
  describe('::addExpression', () => it('adds a previously created expression in the registry', function() {
  ...
  describe('::getExpressions', () => it('returns the expression based on their priority', function() {
  ...
  describe('::removeExpression', () => it('removes an expression with its name', function() {
  ...
  describe('::serialize', () => it('serializes the registry with the function content', function() {
    registry.createExpression('dummy', 'foo');
  ...
  return describe('.deserialize', () => it('deserializes the provided expressions using the specified model', function() {
    const serialized = {
